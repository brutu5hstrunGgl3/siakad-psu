                    ...
                    <form action="{{ route('subject.update', $subject) }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2 @error('academy_year') is-invalid @enderror"
                                    name="academy_year">
                                    <option value="">Pilih Tahun Ajaran</option>
                                    <option value="2022/2023" @if ($subject->academy_year == '2022/2023') selected @endif>2022/2023
                                    </option>
                                    <option value="2023/2024" @if ($subject->academy_year == '2023/2024') selected @endif>2023/2024
                                    </option>
                                    <option value="2024/2025" @if ($subject->academy_year == '2024/2025') selected @endif>2024/2025
                                    </option>
                                </select>
                                <div class="invalid-feedback">
                                    @error('academy_year')
